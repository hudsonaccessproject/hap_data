...
site_points_fulcrum <- st_read("data/published/data/data_updates/current_data_20240619/site_points_20240613.geojson")

act_points_fulcrum<- st_read("data/published/data/data_updates/fulcrum/HAP_act_points_update_20240530.geojson")
# 
site_poly_fulcrum<- st_read("data/published/data/data_updates/current_data_20240619/Hap_site_polys_20240613.geojson")
# 
# ### existing data to compare
# # act_current <- st_read("data/published/data/hap_act_points_20240201.geojson")
# poly_current <- st_read("data/published/data/hap_site_polys_20240115.geojson")
point_current <- st_read("data/published/website/hap/public/assets/hap_site_points_202400606.geojson")
...
max_site_id <- max(site_points_fulcrum$site_id)
