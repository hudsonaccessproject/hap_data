<script>
	...
	const point_url = "/hudsonaccessproject/assets/hap_site_points_20240829.geojson";
	const act_point_url = "/hudsonaccessproject/assets/hap_act_points_20240829.geojson";
	const polygon_url = "/hudsonaccessproject/assets/hap_site_poly_20240829.geojson";
	const temp_url = "/hudsonaccessproject/assets/hap_noaa_stations.geojson";

	// const point_url = "/assets/hap_site_points_20240829.geojson"; 
	// const act_point_url = "/assets/hap_act_points_20240829.geojson";
	// const polygon_url = "/assets/hap_site_poly_20240829.geojson";
