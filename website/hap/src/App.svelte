<script>
	...
	const point_url = "/hudsonaccessproject/assets/hap_site_points_20240724.geojson";
	const act_point_url = "/hudsonaccessproject/assets/hap_act_points_20240724.geojson";
	const polygon_url = "/hudsonaccessproject/assets/hap_site_poly_20240724.geojson";
	const temp_url = "/hudsonaccessproject/assets/hap_noaa_stations.geojson";

	// const point_url = "/assets/hap_site_points_20240724.geojson"; 
	// const act_point_url = "/assets/hap_act_points_20240724.geojson";
	// const polygon_url = "/assets/hap_site_poly_20240724.geojson";
	...
	function resetFilters() {
		...
		//loop through acts and make .isActive false for each one
		acts = acts.map(act => {
			return { ...act, isActive: false };
		});

		// uncheck all the checkboxes in feature filters
		const checkboxes = document.querySelectorAll('.feature-filters input[type="checkbox"]');
		checkboxes.forEach(checkbox => {
			checkbox.checked = false;
		});

		/// in the input #searcher, reset text to blank so that the search bar is empty
